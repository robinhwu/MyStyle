...
var menus: [Menu] = [
    ...
    Menu(name: "雪菜黄鱼汤", type: false, meterials: ["雪菜", "黄鱼", "豆腐"], image: "pickled_vegetable_yellow_fish_soup"),
    ...
    Menu(name: "酸汤肥牛", type: false, meterials: ["牛肉", "金针菇", "泡椒"], image: "sour_soup_with_beef"),
